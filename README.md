...
2/ PiMeCo (2015)  
   See GUI here for projects 1 and 2: https://github.com/endisl/rwd-projects/blob/main/portfolio/portfolio_rendered.png

3/ Code Refactoring  
   Refactoring a one-class application (procedural programming) into a four-class application (OOP programming).  
